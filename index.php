...
<html lang=ru dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Pint «Главная страница»‎</title>
  ...
  <body>
    <div class="wrapper">
      ...
      <main class="content">
       <div class="img-ksap1">
        <img src="Files\Photo\Ksap1.png" align="left" width="650" height="405">
       </div>
       <div class="img-ksap1-1">
        <img src="Files\Photo\Ksap1.1.png" align="left" width="476" height="456">
       </div>
       <div class="img-ksap2">
        <img src="Files\Photo\Ksap2.png" align="right" width="1000" height="621">
       </div>
       <div class="img-ksap2-2">
        <img src="Files\Photo\Ksap2.2.png" align="right" width="99" height="739">
       </div>
       <div class="img-ksap3">
        <img src="Files\Photo\Ksap3.png" align="center">
        <a class="underline-one" align="center" href="#">Рисуй</a>
       </div>
     </main>
